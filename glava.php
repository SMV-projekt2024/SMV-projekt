...
<body>
    <nav>
        <ul class="sidebar" id="sidebar">
            ...
            <li><a href="prva_stran.php">Home</a></li>
            ...
            <?php
                ...
                if ( isset($_SESSION["userId"]) ){
                    ...
                    echo "<li onclick=showSignIn()><a><button>Sign In</button></a></li>";
                    echo "<li onclick=showSignUp()><a><button>Sign Up</button></a></li>";
                }
            ?>
        ...
        <ul>
            ...
            <?php
                if ( isset($_SESSION["userId"]) ){
                    ...
                    echo "<li class='hideMobile' onclick=showSignIn()><a><button>Sign In</button></a></li>";
                    echo "<li class='hideMobile' onclick=showSignUp()><a><button>Sign Up</button></a></li>";
                }
            ?>
    ...
    <div class="zunanjiLogin">
        ...
        <div class="formBox Login">
            ...
            <form action="includes/signin-inc.php" method="post" novalidate>
                ...
                <button type="submit" name="submit" class="loginButton">Sign in</button>
            </form>
        </div>
   </div>
<!--------------Sign UP POPUP---------->
